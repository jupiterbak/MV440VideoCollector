...
FrameCollector.prototype.transmit = function(frame,socket) {
...
FrameCollector.prototype.handleReceived = function(buffer,socket) {
    ...
    if(main_buffer.header !== null){
        ...
        if(buffer.length >= 16){
            ...
            if(_bufferHeader && _bufferHeader.isValidHeader()){
                main_buffer.header = header;
